...
INSERT INTO user(id,name, openid,remark,stuid,groupid) VALUES(4,'fa','toid222','{}','26','[1]');
...
DELETE FROM attnd WHERE cipher='Gwvk1' or cipher='Awvk2' OR cipher ='Awvq3' or id = 4 or id = 5 or id = 6;
...
(1,'操作系统1','Gwvk1',1522512000,20,'{"accuracy": 30.0, "latitude": 23.4, "longitude": 174.4}','理南105','网工151',1	,'lzy',2,'{}','2018-05-20');

INSERT INTO attnd(id,name,cipher,starttime,lasttime,location,addrname,groupname,teacherid,teachername,status,remark,createdat) VALUES
(2,'计算机网络','Awvk2',1522512000,20,'{"accuracy": 30.0, "latitude": 23.4, "longitude": 174.4}','理北316','计科151',1	,'lzy',1,'{}','2018-05-21');

INSERT INTO attnd(id,name,cipher,starttime,lasttime,location,addrname,groupname,teacherid,teachername,status,remark,createdat) VALUES
(3,'编译原理','Awvq3',1522512000,20,'{"accuracy": 30.0, "latitude": 23.4, "longitude": 174.4}','文新717','网工151',1	,'lzy',1,'{}','2018-05-18');

INSERT INTO attnd(id,name,cipher,starttime,lasttime,location,addrname,groupname,teacherid,teachername,status,remark,createdat) VALUES
(4,'高级网站开发','NQSA4',1522512000,20,'{"accuracy": 30.0, "latitude": 23.4, "longitude": 174.4}','文俊701','',1	,'lzy',3,'{}','2018-05-22');

INSERT INTO attnd(id,name,cipher,starttime,lasttime,location,addrname,groupname,teacherid,teachername,status,remark,createdat) VALUES
(5,'数据结构','Awvq1',1522512000,20,'{"accuracy": 30.0, "latitude": 23.4, "longitude": 174.4}','电子楼517','计科151',1	,'lzy',3,'{}','2018-05-15');

INSERT INTO attnd(id,name,cipher,starttime,lasttime,location,addrname,groupname,teacherid,teachername,status,remark,createdat) VALUES
(6,'通信原理','GZXQ6',1522512000,20,'{"accuracy": 30.0, "latitude": 23.4, "longitude": 174.4}','B12-214','计科151',1	,'lzy',4,'{}','2018-05-17');
