...
INSERT INTO attnd(id,name,cipher,starttime,lasttime,location,addrname,groupname,teacherid,teachername,status,remark,createdat) VALUES
(3,'编译原理','Awcq31',1522512000,20,'{"accuracy": 30.0, "latitude": 23.4, "longitude": 174.4}','外环西路3','网工151',1	,'lzy',1,'{}','2018-05-18');

INSERT INTO attnd(id,name,cipher,starttime,lasttime,location,addrname,groupname,teacherid,teachername,status,remark,createdat) VALUES
(4,'高级网站开发','NQSA4',1522512000,20,'{"accuracy": 30.0, "latitude": 23.4, "longitude": 174.4}','外环西路4','',1	,'lzy',3,'{}','2018-05-22');

INSERT INTO attnd(id,name,cipher,starttime,lasttime,location,addrname,groupname,teacherid,teachername,status,remark,createdat) VALUES
(5,'数据结构','Awvq52',1522512000,20,'{"accuracy": 30.0, "latitude": 23.4, "longitude": 174.4}','外环西路5','计科151',1	,'lzy',3,'{}','2018-05-15');

INSERT INTO attnd(id,name,cipher,starttime,lasttime,location,addrname,groupname,teacherid,teachername,status,remark,createdat) VALUES
(6,'通信原理','GZXQ6',1522512000,20,'{"accuracy": 30.0, "latitude": 23.4, "longitude": 174.4}','外环西路5','',1	,'lzy',4,'{}','2018-05-17');

INSERT INTO signin(id,openid, cipher, location, remark,status,distance) VALUES (1,'toid789','Awvq52','{"accuracy": 30.0, "latitude": 23.4, "longitude": 174.4}','{}',1,75.4);
INSERT INTO signin(id,openid, cipher, location, remark,status,distance) VALUES (2,'toid123','Awvq52','{"accuracy": 30.0, "latitude": 23.4, "longitude": 174.4}','{}',2,75.4);
